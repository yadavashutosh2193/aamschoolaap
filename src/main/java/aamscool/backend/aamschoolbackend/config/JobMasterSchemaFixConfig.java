    ...
    public CommandLineRunner jobMasterSchemaFixRunner(JdbcTemplate jdbcTemplate) {
        return args -> {
            List<String> alters = List.of(
                    ...
                    "ALTER TABLE job_master MODIFY COLUMN date_posted DATE NULL",
                    "ALTER TABLE job_master MODIFY COLUMN date_updated DATE NULL",
                    "ALTER TABLE job_master MODIFY COLUMN job_location JSON NULL",
